...
def init(difficulty):
    ...
    print ("""
    _____________________________________________    _                  _       _____   _              _   _
                                               _ \  | |                | |     / ____| | |            | | | |
                                              |_) | | |   ___     ___  | | __ | (___   | |__     ___  | | | |
                                               _ <  | |  / _ \   / __| | |/ /  \___ \  | '_ \   / _ \ | | | |
                                              |_) | | | | (_) | | (__  |   <   ____) | | | | | |  __/ | | | |
    _____________________________________________/  |_|  \___/   \___| |_|\_\ |_____/  |_| |_|  \___| |_| |_|

                                            > A command line utility for learning Blockchain concepts.
                                            > Type 'help' to see supported commands.
                                            > Project by Daxeel Soni - https://daxeel.github.io
                                            >  edited by Gad Mohamed - https://github.com/gadm21
...
def getblock(cmd):
    ...
    for eachBlock in coin.chain:
        if eachBlock.hash == blockHash:
            print ("")
            data = eachBlock.data 
            print("vote: {}".format(data)) 
            print ("")

def countvotes(cmd):
    candidates = { block.data : 0 for block in coin.chain }

    for block in coin.chain : 
        candidates[block.data] += 1 
    
    for key, value in candidates.items() :
        if key == 'Genesis Block' : continue 
        print("candidate {} got {} votes".format(key, value)) 
